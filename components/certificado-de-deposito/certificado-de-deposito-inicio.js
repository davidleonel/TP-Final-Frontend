...
var CertificadoDeDeposito = React.createClass ({
    ...
    getRequest: function () {
        var request = new Request('http://proyecto-final-prim.herokuapp.com/certificadodedeposito/getAll', {
            method: 'GET',
            headers: new Headers({
    ...
    //falta updetear el header de las columnas de la tabla
                                ...
                                <TableRow>
                                    <TableHeaderColumn colSpan="8" tooltip="Super Header" style={{textAlign: 'right'}}>
                                        ...
                                        <RaisedButton
                                            ...
                                            label="Generar nuevo Deposito"
                                            onTouchTap={this.handleGenerarNuevoDeposito}
                                            />
                                    </TableHeaderColumn>
                                </TableRow>
                                <TableRow>
    ...
    //*****************************************************************//
    //falta machear estos campos con los de la tabla
    ...
    handleGenerarNuevoDeposito: function () {
